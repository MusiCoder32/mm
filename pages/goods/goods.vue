	...
	export default {
		data() {
			return {
				...
				goodsData: {
					goods_id: 1,
					goods_name: "商品标题商品标题商品标题商品标题商品标题商品标题商品标题商品标题商品标题",
					price: "127.00",
					number: 1,
					service: [{
							name: "正品保证",
		...
		onLoad(option) {
			...
			console.log(option.goods_id); //打印出上个页面传递的参数。
		...
		methods: {
			...
			toConfirmation() {
				...
				let goods = {
					...
					imagePath: this.rootPath+uni.getStorageSync('imagePath'),
					name: this.goodsData.goods_id,
