		...
		<view class="category-list">
			...
			<scroll-view scroll-y="true" class="right">
				<view class="category" v-for="(category,index) in categoryList" :key="category.id" v-show="index==showCategoryIndex">
					...
					<view class="list">
						<view class="box" v-for="(box,i) in category.son" :key="i" @tap="toCategory(box)">
							<image :src="rootPath+box.icon_path"></image>
							<view class="text">{{box.type_name}}</view>
						</view>
					</view>
				</view>
			</scroll-view>
...
<script>
	...
	export default {
		...
		onLoad() {
			...
			this.categoryList = this.goodTypeAll
		...
		methods: {
			...
			toCategory(e) {
				uni.setStorageSync('catName', e.catName);
				uni.navigateTo({
					url: '../../goods/goods-list/goods-list?cid=' + e.id + '&name=' + e.catName
				});
			},
			//搜索跳转
			toSearch() {
