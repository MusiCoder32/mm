...
var _self;var _default = { data: function data() {return { page: 1, //查询数据页数，后台默认每页十条
    ...
    Object.assign(_self.goodsListQueryData, uni.getStorageSync('queryData'));console.log(_self.goodsListQueryData, " at pages\\goods\\goods-list\\goods-list.nvue:107");this.rootPath = _config.default.APIHOST + _config.default.IMGPATH;this.httpRequest(_self.goodsListQueryData);}, mounted: function mounted() {// nvue页面下，关闭下拉刷新，用waterfall实现下拉和上拉刷新。
    ...
    httpRequest: function httpRequest(data) {var add = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      ...
      uni.request({
        ...
        fail: function fail(e) {
          ...
          console.log(e, " at pages\\goods\\goods-list\\goods-list.nvue:162");
        },
